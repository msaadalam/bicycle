        ...
        <form method="post" action="{{route('createfaqs')}}">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-12">
                    ...
                    <input type="text" name="question" id="question" class="form-control" placeholder="Please enter name" required>
                </div>
                <div class="col-md-12">
                    <label class="form-label" for="description">Description</label>
                    <textarea row="5" class="form-control" cols="20" rows="10" name="description" id="description" placeholder="Please enter description" required></textarea>
                    </div>
            </div>
            <div class="col-md-12 my-4">
